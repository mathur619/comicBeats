...
<div class="main">
	<div class="side">
		...
		<div class="option">Add Character</div>
		<div class="option"> Update Character</div>
		<div class="option"> Delete Character</div>
		<div class="option"> Add Comic</div>
		<div class="option"> Update Comic</div>
		<div class="option"> Delete Comic</div>
		<div class="option"> Add Item</div>
		<div class="option"> Update Item</div>
		<div class="option"> Delete Item</div>	
...
<?php
	...
	$q=mysqli_query($conn,"select ComicName from characterinfo");
	echo "<div class='row'>";
...
<div class="form-group">
    <div class="col-sm-offset-2 col-sm-10">
      <input type="submit" class="btn btn-default add" value="Update Character"> 
    </div>
  </div>
</form>
	  </div>
