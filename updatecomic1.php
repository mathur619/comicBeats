...
<?php
	...
	$q=mysqli_query($conn,"select Name from comicinfo");
	echo "<div class='row'>";
	while($r=mysqli_fetch_array($q)){
		echo "<div class='col-lg-3'>".
				$r['Name'].
			" <input type='radio' name='comic'></div>";
			}
	echo "</div>";
?>
<form class="form-horizontal " action="updatecomic2.php" method="post">
<div class="form-group">
    <div class="col-sm-offset-2 col-sm-10">
      <input type="submit" class="btn btn-default add" value="Update Comic"> 
    </div>
  </div>
</form>
	  </div>
