...
<div class="main">
	<div class="side">
		...
		<div class="option"> Wallet</div>
		<div class="option"> My Orders</div>
	...
	<div class="admin">
	  <div class="content">
		<div class="row">
			...
			<a href="updatecharacter1.php">
			<div class="col-lg-3"> 
				Update Character
			</div>
			</a>
			<a href="deletecharacter.php">
			<div class="col-lg-3"> 
				Delete Character
			</div>
			</a>
		...
		<a href="addcomic.php">
			...
			<a href="updatecomic1.php">
			<div class="col-lg-3"> 
				Update Comic
			</div>
			</a>
			<a href="deletecomic.php">
			<div class="col-lg-3"> 
				Delete Comic
			</div>
			</a>
