...
// 					echo $r;
 ...
 echo "
        ...
        <form class='form-horizontal' action='newsignup.php' method='post'>
       <div class='form-group'>
    <label for='firstname' class='col-sm-2 control-label'>First Name</label>
    <div class='col-sm-10'>
      <input type='text' class='form-control' id='firstname' name='fName' placeholder='$fname' required='required' value='$fname'>
    </div>
  </div>
  ...
  <div class='form-group'>
    ...
    <div class='col-sm-10'>
      <input type='text' class='form-control' id='lastname' name='lName' placeholder='$lname' required='required' value='$lname'>
    </div>
  </div>
